...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//Pernah Sekolah PAUD
	if(empty($_POST["pernah_sekolah_paud"])){
		$error_pernah_sekolah_paud="Pilihan tidak boleh kosong";
	}
	else{
		$pernah_sekolah_paud=cek_input($_POST["pernah_sekolah_paud"]);
	}

	//Pernah TK
	if(empty($_POST["pernah_sekolah_tk"])){
		$error_pernah_sekolah_tk="Pilihan tidak boleh kosong";
	}
	else{
		$pernah_sekolah_tk=cek_input($_POST["pernah_sekolah_TK"]);
	}
